package cn.fundview.app.camera;
...
//		cameraResolution = getCameraResolution(parameters, screenResolution);
    ...
    /**
     * ��ȡ���ֱ��� ���ֻ�����ͷ��Ĭ��֧�ֵ�Ԥ���ߴ���,
     * ��СĬ�϶���8�ı���,��������ȡ����Ԥ���ߴ�ʱ����Կ���ʹ����Ļ�Ĵ�С��Ϊ����ͷ�ķֱ���,������Ҫȷ����С����8 �ı���
     *
     * @param parameters
    ...
    private static Point getCameraResolution(Camera.Parameters parameters, Point screenResolution) {
        ...
        System.out.println(previewSizeValue);
        // saw this on Xperia
        if (previewSizeValue == null) {
            previewSizeValue = parameters.get("preview-size-value");
        }
        ...
        if (previewSizeValue != null) {
            ...
            cameraResolution = findBestPreviewSizeValue(previewSizeValue, screenResolution);
        }
    ...
    /**
     * �����Ļ�ķֱ��ʺ����֧�ֵ�Ԥ���ߴ���ѡ������ʵ�Ԥ����С(�ߴ���ӽ��) ѭ���Ƚ�Ԥ���ߴ����Ļ�ߴ�
     *
     * @param previewSizeValue
     * @param screenResolution
     * @return Point
     */
    private static Point findBestPreviewSizeValue(CharSequence previewSizeValue, Point screenResolution) {
        int bestX = 0;
        int bestY = 0;
        int diff = Integer.MAX_VALUE;
        System.out.println("screenResolution = " + screenResolution);
        for (String previewSize : COMMA_PATTERN.split(previewSizeValue)) {
    ...
    public Size getPropPreviewSize(List<Size> list, float th, int minWidth) {
        ...
        for (Size s : list) {
            if ((s.width >= minWidth) && equalRate(s, th)) {
                System.out.println("PreviewSize:w = " + s.width + ",h = " + s.height);
                break;
            }
            i++;
        }
...
//	    }  
    ...
    private boolean equalRate(Size size, float rate) {
        ...
        if (size != null) {
            ...
            float rate_1 = size.width * 1.0f / size.height * 1.0f;
            if (rate == rate_1) {
